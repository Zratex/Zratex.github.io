...
function MusicManager(state) {
    ...
    if (window.getComputedStyle(document.getElementById("next_set")).display=="none") {
        document.getElementById("SFX").setAttribute("src","https://raw.githubusercontent.com/Zratex/gallery/main/rps/SFX/Select.wav");
    } else {
        document.getElementById("SFX").setAttribute("src","https://raw.githubusercontent.com/Zratex/gallery/main/rps/SFX/Next Round.wav");
    }
    ...
    if (state==1 && (document.getElementById("gamescoreHuman").textContent!=2 && document.getElementById("gamescoreCPU").textContent!=2)) {
        ...
        if (document.getElementById("OST").getAttribute("src")!="https://raw.githubusercontent.com/Zratex/gallery/main/rps/OST Battle/Round 1 - Not A Little Girl.mp3" && document.getElementById("setscoreHuman").textContent=="0" && document.getElementById("setscoreCPU").textContent=="0") {
            document.getElementById("OST").setAttribute("src","https://raw.githubusercontent.com/Zratex/gallery/main/rps/OST Battle/Round 1 - Not A Little Girl.mp3");
            document.getElementById("OST").play();
            document.getElementById("OST").loop=true;
            document.getElementById("OST").volume = 0.1;
        } else {
            if (document.getElementById("OST").getAttribute("src")!="https://raw.githubusercontent.com/Zratex/gallery/main/rps/OST Battle/Round 2 - Not A Little Girl.mp3"
            && (document.getElementById("setscoreHuman").textContent=="1" || document.getElementById("setscoreCPU").textContent=="1") && (document.getElementById("setscoreHuman").textContent!="2" && document.getElementById("setscoreCPU").textContent!="2")
                ...
                if (document.getElementById("gamescoreHuman").textContent=="0" && document.getElementById("gamescoreCPU").textContent=="0") {
                    document.getElementById("OST").setAttribute("src","https://raw.githubusercontent.com/Zratex/gallery/main/rps/OST Battle/Round 2 - Not A Little Girl.mp3");
                    document.getElementById("OST").play();
                    document.getElementById("OST").loop=true;
                    document.getElementById("OST").volume = 0.1;
                }
            } else {
                if (document.getElementById("OST").getAttribute("src")!="https://raw.githubusercontent.com/Zratex/gallery/main/rps/OST Battle/Round 3 - Not A Little Girl.mp3") {
                    if (document.getElementById("setscoreHuman").textContent=="2" || document.getElementById("setscoreCPU").textContent=="2") {
                        if (document.getElementById("gamescoreHuman").textContent=="0" && document.getElementById("gamescoreCPU").textContent=="0") {
                            document.getElementById("Announcer").setAttribute("src","https://raw.githubusercontent.com/Zratex/gallery/main/rps/Announcer/Final Round.wav");
                            document.getElementById("Announcer").play()
                            document.getElementById("Announcer").volume=0.2;
                            document.getElementById("OST").setAttribute("src","https://raw.githubusercontent.com/Zratex/gallery/main/rps/OST Battle/Round 3 - Not A Little Girl.mp3");
                            document.getElementById("OST").play();
                            document.getElementById("OST").loop=true;
                            document.getElementById("OST").volume = 0.1;
                        }
        ...
        if (state==2 && document.getElementById("OST").getAttribute("src")!="https://raw.githubusercontent.com/Zratex/gallery/main/rps/OST Battle/Low Health - Not A Little Girl.mp3") {
            //Introduction de la phase low health
            document.getElementById("OST").setAttribute("src","https://raw.githubusercontent.com/Zratex/gallery/main/rps/OST Battle/Low Health (intro) - Not A Little Girl.mp3");
            document.getElementById("OST").play();
            document.getElementById("OST").volume = 0.1;
            setTimeout(() => {
                //Transition à la phase low health
                document.getElementById("OST").pause();
                document.getElementById("OST").setAttribute("src","https://raw.githubusercontent.com/Zratex/gallery/main/rps/OST Battle/Low Health - Not A Little Girl.mp3");
                document.getElementById("OST").play();
                document.getElementById("OST").loop=true;
            },1300);
        } else {
            if (state==3) {
                ...
                if (document.getElementById("setscoreHuman").textContent==3 || document.getElementById("setscoreCPU").textContent==3) {
                    ...
                    if (document.getElementById("setscoreHuman").textContent==3) {
                        document.getElementById("Announcer").setAttribute("src","https://raw.githubusercontent.com/Zratex/gallery/main/rps/Announcer/[Announcer]_SFIII_3rd_Strike_-_You_win.mp3");
                    } else {
                        document.getElementById("Announcer").setAttribute("src","https://raw.githubusercontent.com/Zratex/gallery/main/rps/Announcer/[Announcer]_SFIII_3rd_Strike_-_You_lose.mp3");
                    }
                    document.getElementById("Announcer").play();
                    document.getElementById("OST").setAttribute("src","https://raw.githubusercontent.com/Zratex/gallery/main/rps/OST Battle/End - Not A Little Girl.mp3");
                    ...
                    if (setscore.textContent==2) {
                        document.getElementById("OST").setAttribute("src","https://raw.githubusercontent.com/Zratex/gallery/main/rps/OST Battle/Transition - Not A Little Girl.mp3");
                    } else {
                        // Transition sur le dernier set
                        document.getElementById("OST").setAttribute("src","https://raw.githubusercontent.com/Zratex/gallery/main/rps/OST Battle/Round End - Not A Little Girl.mp3");
                    }
                    document.getElementById("OST").play();
                    document.getElementById("OST").loop=true;
                    document.getElementById("OST").volume = 0.1;
